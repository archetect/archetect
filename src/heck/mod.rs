...
//! PascalCase and snake_case. It is intended to be unicode aware, internally,
...
//! indicators are dropped, except insofar as PascalCase capitalizes the first word.
//!
    ...
    G: Fn(&mut String),
{
    ...
    /// the mode is `Lowercase`. Otherwise, the mode is `Uppercase`.
