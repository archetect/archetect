...
use archetect_api::{ScriptMessage, ClientMessage, PromptInfo, SelectPromptInfo};
...
pub fn prompt<'a, K: AsRef<str> + Clone>(
    ...
    archetect.request(ScriptMessage::PromptForSelect(prompt_info.clone())).map_err(io_error_to_script_error)?;
