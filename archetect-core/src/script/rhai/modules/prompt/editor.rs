...
use rhai::{Dynamic, Map, EvalAltResult, NativeCallContext};
use archetect_api::{CommandRequest, CommandResponse, EditorPromptInfo, PromptInfo};
...
pub fn prompt<'a, K: AsRef<str> + Clone>(
    ...
    let prompt_info = EditorPromptInfo::new(message)
    ...
    runtime_context.request(CommandRequest::PromptForEditor(prompt_info.clone()));
