...
pub(crate) fn create_engine(
    ...
    modules::pair_module::register(&mut engine);
    modules::prompt_module::register(
        &mut engine,
        render_context.clone(),
        archetect.clone(),
    );
    modules::set_module::register(&mut engine, render_context.clone());
    ...
    modules::git_module::register(&mut engine, archetect.clone(), render_context.clone());
    modules::github_module::register(&mut engine, archetect.clone());
